...
function testCaseForIsObject() {
  // 直接定义的空对象
  print(isObject({})); // Object创建的空对象

  print(isObject(Object.create({}))); // Object创建的符合Object原型的对象

  print(isObject(Object.create(Object.prototype))); // Object创建的null

  print(isObject(Object.create(null))); // new关键字创建的对象

  print(isObject(new Foo())); // 正则对象
...
function testTypeNotObject() {
  ...
  print(isObject(function () {})); // number

  print(isObject(1)); // array

  print(isObject([])); // undefined

  print(isObject(undefined)); // null
