 ...
 */
var log = console.log;
var str = 'hello world!'; // log(str.substr(2, 3));
// // llo
// log(str.substr(-3, 2));
// // ld
// // 如果索引为负数，则
...
function _substr(startIndex) {
  let length = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.length;
  // debugger
...
Object.prototype._substr = _substr; // log(str._substr(2, 3));
// log(str._substr(0, 3));
// log(str._substr(-3, 2));
// // llo
// // hel
...
log(str.substr('test')); // hello world!

log(str.substr('test', 2)); // he

log(str._substr('test')); // hello world!

log(str._substr('test', 2)); // he
